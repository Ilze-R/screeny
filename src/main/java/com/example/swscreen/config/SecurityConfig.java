...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = {"/user/new/password/**", "/user/verify/password/**", "/api/login/**", "/user/verify/code/**", "/api/register/**", "/user/resetpassword/**", "/user/verify/account/**", "/user/refresh/token/**", "/user/image/**", "/api/**"};
